...
| 方法 | 机制（为什么可能有用） | 证据强度 | 关键研究 / 来源 | 适用人群与任务 | 适用条件 | 局限与反证 |
| --- | --- | --- | --- | --- | --- | --- |
...
- **执行者与剂量**：这一条由谁做（我本人操作 / AI 代做产出物），单次会话内能否兑现；需跨天练习或长期训练才生效的，写明"单次会话内无法兑现"并降为可选项
- **机制**：它靠什么起作用，预期改变什么
...
- 正效应研究里是被试本人做操作，还是 AI 代做产出物？两者不同时必须写出这个断裂（读图不等于构图）
- 区分"已证明无效"与"尚无证据"：某个做法找不到 meta，只能写"本次检索不到"，不能写成"已证明不存在"
